...

{
  ...
  (**(code **)&param_1->field_0x1054)("brightness_level",&param_1->field_0xed5,1);
  (**(code **)&param_1->field_0x1054)("3dof_enable",&(param_1->imu_fusion_context).field_0x7c,1);
  (**(code **)&param_1->field_0x1054)("display_mode",&param_1->field_0xfee,1);
  (**(code **)&param_1->field_0x1054)("wakeup_angle",&(param_1->imu_fusion_context).field_0x10,1);
