/*
 * Function: FUN_00035ed8
 * Entry:    00035ed8
 * Prototype: undefined4 __stdcall FUN_00035ed8(int param_1)
 */


undefined4 FUN_00035ed8(int param_1)
    ...
    if ((iVar1 == 0) || (iVar1 = strncmp("com.apple.mobilephone",s2,0x15), iVar1 == 0)) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          pcVar5 = &DAT_20003175;
          if (pGVar2->field3664_0x1080[0] != 0) {
            pcVar5 = &DAT_200032b5;
          }
          for (; *pcVar5 != '\0'; pcVar5 = pcVar5 + 0x20) {
            sVar4 = ____strlen(pcVar5);
            sVar4 = sVar4 & 0xff;
            if (0x1e < sVar4) {
              sVar4 = 0x1f;
            }
