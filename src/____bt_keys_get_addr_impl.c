/*
 * Function: $_?_bt_keys_get_addr_impl
 * Entry:    000618c0
 * Prototype: bt_keys * __stdcall $_?_bt_keys_get_addr_impl(uint param_1, undefined4 * param_2)
 */


bt_keys * ____bt_keys_get_addr_impl(uint param_1,undefined4 *param_2)
