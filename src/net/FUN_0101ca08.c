/*
 * Function: FUN_0101ca08
 * Entry:    0101ca08
 * Prototype: uint __stdcall FUN_0101ca08(int param_1)
 */


uint FUN_0101ca08(int param_1)

{
  ...
  uVar1 = FUN_0100dbc0(*(int *)(param_1 + 4) + 0xa8,0,(uint)*(byte *)(*(int *)(param_1 + 4) + 0xc5),
                       0);
  if (uVar1 != 0) {
    *(undefined1 *)(*(int *)(param_1 + 4) + 0xc5) = 0xc;
    return uVar1;
  }
  iVar2 = FUN_01009500(0x36,0x4d6,extraout_r2,extraout_r3);
  if (DAT_2100112c == '\0') {
    if (iVar2 != 1) {
