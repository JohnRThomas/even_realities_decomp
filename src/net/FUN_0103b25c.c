/*
 * Function: FUN_0103b25c
 * Entry:    0103b25c
 * Prototype: int __stdcall FUN_0103b25c(int * param_1, uint param_2, undefined4 * param_3, int param_4)
 */


int FUN_0103b25c(int *param_1,uint param_2,undefined4 *param_3,int param_4)
