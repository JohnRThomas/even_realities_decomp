/*
 * Function: FUN_0100e86c
 * Entry:    0100e86c
 * Prototype: uint __stdcall FUN_0100e86c(int param_1, undefined4 * param_2, uint param_3, undefined4 param_4)
 */


uint FUN_0100e86c(int param_1,undefined4 *param_2,uint param_3,undefined4 param_4)

{
  ...
  uVar4 = FUN_01009500(0x2a,0xee,param_3,param_4);
  if (extraout_r2 < 0x20) {
    uVar1 = FUN_01026198((undefined4 *)((int)uVar4 + 9),(undefined4 *)((ulonglong)uVar4 >> 0x20),
                         extraout_r2);
    *(char *)((int)uVar4 + 1) = (char)extraout_r2 + '\x06';
    return uVar1;
  }
  uVar4 = FUN_01009500(0x2a,0x110,extraout_r2,extraout_r3);
  pbVar2 = (byte *)uVar4;
  if ((*pbVar2 & 0xf) == 3) {
