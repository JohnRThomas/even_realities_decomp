/*
 * Function: FUN_0100d7f4
 * Entry:    0100d7f4
 * Prototype: undefined __stdcall FUN_0100d7f4(undefined4 * param_1, int param_2)
 */


void FUN_0100d7f4(undefined4 *param_1,int param_2)

{
  uint uVar1;
  
  if (param_2 == 0) {
    FUN_01026284(param_1,0,0x3f0);
    ...
    *(undefined1 *)(param_1 + 0xd9) = 0x20;
    return;
  }
  if (param_2 == 1) {
    uVar1 = param_1[5];
    *(undefined2 *)((int)param_1 + 0x2f6) = 0;
    *(undefined1 *)((int)param_1 + 0x2eb) = 0;
  ...
  if (param_2 == 2) {
    ...
    *(short *)(param_1 + 0x3e) =
         (short)(((uint)*(ushort *)((int)param_1 + 0x3ca) * 10000 + (uVar1 - 1)) / uVar1);
