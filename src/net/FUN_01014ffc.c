/*
 * Function: FUN_01014ffc
 * Entry:    01014ffc
 * Prototype: undefined __stdcall FUN_01014ffc(int param_1)
 */


uint FUN_01014ffc(int param_1)

{
  ...
  iVar5 = *(int *)(param_1 + 4);
  if (*(byte *)(iVar5 + 0xc6) == 0x17) {
    *(undefined1 *)(iVar5 + 0xc6) = 0x1b;
    return param_1;
  }
  uVar2 = FUN_01009500(0x31,0x4c1,(uint)*(byte *)(iVar5 + 0xc6),iVar5);
  iVar5 = *(int *)(uVar2 + 4);
  if (*(byte *)(iVar5 + 0xc6) == 0x17) {
    *(undefined1 *)(iVar5 + 0xc6) = 0x19;
    return uVar2;
  }
  uVar2 = FUN_01009500(0x31,0x4bb,(uint)*(byte *)(iVar5 + 0xc6),iVar5);
  iVar5 = *(int *)(uVar2 + 4);
  if (*(byte *)(iVar5 + 0xc6) == 0x16) {
    *(undefined1 *)(iVar5 + 0x105) = 1;
    *(undefined1 *)(iVar5 + 0xc6) = 0x17;
    return uVar2;
  }
  uVar2 = FUN_01009500(0x31,0x4b4,(uint)*(byte *)(iVar5 + 0xc6),iVar5);
  iVar5 = *(int *)(uVar2 + 4);
