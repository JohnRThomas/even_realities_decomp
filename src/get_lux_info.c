...

{
  ...
  if ((param_3 == (undefined4 *)0x0) || (param_4 == (undefined1 *)0x0)) {
    ...
    *(undefined4 *)(puVar4 + 0x1c) = *(undefined4 *)&pGVar3->field_0xfb8;
    pGVar3 = __get_dashboard_state();
    uVar5 = __aeabi_f2d((uint)(float)(longlong)*(int *)&pGVar3->field_0xfb4,extraout_r1,extraout_r2,
                        extraout_r3);
    uVar5 = __divdf3((uint)uVar5,(uint)(uVar5 >> 0x20),0,0x412e8480);
    uVar6 = __floatunsidf(uVar2);
    uVar5 = __muldf3((uint)uVar5,(uint)(uVar5 >> 0x20),(uint)uVar6,(uint)(uVar6 >> 0x20));
    uVar2 = __fixunsdfsi((uint)uVar5,(uint)(uVar5 >> 0x20));
