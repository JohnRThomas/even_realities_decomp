...

{
  ...
  global_state_struct_0FF4 *pgVar4;
  ...
  *(undefined2 *)(uVar8 + 0x1070) = 0;
  ...
  pgVar4 = malloc(7);
  s->glasses_state_struct_0FF4 = pgVar4;
  puVar4 = malloc(5);
  ...
  pvVar5 = malloc(0x217);
  *(void **)&s->field_0x1000 = pvVar5;
  if (pvVar5 != (void *)0x0) {
    memset(pvVar5,0,0x217);
  }
  pvVar5 = malloc(0xf5);
  *(void **)&s->field_0x1004 = pvVar5;
  pvVar5 = malloc(0x1e8);
  *(void **)&s->field_0x1008 = pvVar5;
  pvVar5 = malloc(0x1e8);
  *(void **)&s->field_0x100c = pvVar5;
  pvVar5 = malloc(0x1e9);
  *(void **)&s->field_0x1010 = pvVar5;
  pvVar5 = malloc(0x210);
  *(void **)&s->field_0x1014 = pvVar5;
  if (pvVar5 != (void *)0x0) {
    memset(pvVar5,0,0x210);
  }
  pvVar5 = malloc(0x50f);
  *(void **)&s->field_0x1030 = pvVar5;
  if (pvVar5 != (void *)0x0) {
    memset(pvVar5,0,0x50f);
  }
  pvVar5 = malloc(0x152);
  *(void **)&s->field_0x1034 = pvVar5;
  if (pvVar5 != (void *)0x0) {
    memset(pvVar5,0,0x152);
  }
  pvVar5 = malloc(0x201);
  *(void **)&s->field_0x1038 = pvVar5;
  if (pvVar5 != (void *)0x0) {
    memset(pvVar5,0,0x201);
  }
  pvVar5 = malloc(0x201);
  *(void **)&s->field_0x103c = pvVar5;
  if (pvVar5 != (void *)0x0) {
    memset(pvVar5,0,0x201);
  }
  pvVar5 = malloc(0x16a);
  *(void **)&s->field_0xff8 = pvVar5;
  if (pvVar5 != (void *)0x0) {
    *(undefined1 *)((int)pvVar5 + 0x168) = 0;
    *(undefined4 *)((int)pvVar5 + 0x164) = 0;
  }
  pvVar5 = malloc(0xaf);
  *(void **)&s->field_0xffc = pvVar5;
  puVar6 = malloc(0xb);
  ...
  *(undefined2 *)&s->field_0xb2c = 0x200b;
  uVar15 = spi_master_register_context(&s->spi_master_callbacks);
  DEVICE_ROLE = button_init((int)uVar15,(int)((ulonglong)uVar15 >> 0x20),extraout_r2_00);
...
LAB_00017390:
      if (BLE_DEBUG == 0) {
        ...
        ble_printk(pcVar12,"role_init",DVar1,BLE_DEBUG);
      }
    }
  }
...
LAB_00017458:
    if (1 < LOG_LEVEL) {
      if (BLE_DEBUG == 0) {
        ...
        ble_printk("%s(): enter\n","component_init",uVar10,BLE_DEBUG);
      }
    }
  }
  else {
    uVar15 = FUN_0001832c((undefined4 *)&s->field_0x77c);
    if (*(char *)s == '\x01') {
    ...
    register_jdb_panel_context((undefined4 *)&s->field_0xb6c);
    nfc_init();
    uVar15 = init_dashboard_info();
  ...
  if (*(char *)s == '\x01') {
    ...
    iVar11 = (*(code *)(s->opt3007_context).field0_0x0)(&s->opt3007_context);
    if ((iVar11 != 0) && (1 < LOG_LEVEL)) {
      if (BLE_DEBUG == 0) {
  ...
  bVar3 = z_device_is_ready((device *)&PTR_s_regulators_0008b460);
  if (bVar3) {
    printk("pmic regulator %s is ready to use.\n","regulators");
    bVar3 = z_device_is_ready((device *)&PTR_s_charger_0008b520);
    if (bVar3) {
      ...
      if (iVar11 < 0) {
        ...
        if (-1 < iVar11) {
          ...
          uVar15 = (**(code **)&s->field_0xb6c)(&s->field_0xb6c);
          ...
          *(undefined4 *)&s->field_0x1090 = 0;
          FUN_000805b4((uint *)&s->field_0x1090,uVar10,uVar13);
...
LAB_000174fc:
  ...
  do {
    ...
    while( true ) {
      uVar14 = (uint)(byte)s->field_0x106d;
      if (uVar14 == 0) break;
      if ((int)(uVar14 << 0x1f) < 0) {
        FUN_0007f556((int)s);
        bVar2 = s->field_0x106d & 0xfe;
        goto LAB_00017714;
      }
      if ((int)(uVar14 << 0x1e) < 0) {
        s->field_0xfee = 0xb;
        bVar2 = s->field_0x106d & 0xfd;
        goto LAB_00017714;
      }
      if ((int)(uVar14 << 0x1d) < 0) {
        do_pdm_transfer();
        bVar2 = s->field_0x106d & 0xfb;
        goto LAB_00017714;
      }
      if ((int)(uVar14 << 0x1c) < 0) {
        erase_dfu_flash();
        bVar2 = s->field_0x106d & 0xf7;
LAB_00017714:
        s->field_0x106d = bVar2;
      }
    }
    sleep(1);
