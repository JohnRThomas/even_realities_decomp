...
LAB_000180b8:
  ...
  pvVar2 = GLOBAL_STATE.sem_1.poll_events.prev;
  uVar13 = sys_clock_tick_get();
  pvVar3 = GLOBAL_STATE.sem_1.poll_events.prev;
  lVar1 = (uVar13 & 0xffffffff) * 1000;
  *(uint *)((int)pvVar2 + 0x368) =
       (uint)lVar1 >> 0xf |
       ((int)(uVar13 >> 0x20) * 1000 + (int)((ulonglong)lVar1 >> 0x20)) * 0x20000;
  pvVar2 = GLOBAL_STATE.sem_1.poll_events.prev;
  if ((*(char *)((int)pvVar3 + 0x248) == '\0') && (*(int *)((int)pvVar3 + 0x220) == 0)) {
    if (packet_size < 0x15) {
      memcpy(*(void **)((int)GLOBAL_STATE.sem_1.poll_events.prev + 0x254),packet_data,packet_size);
      memset((void *)(*(int *)((int)pvVar2 + 0x254) + packet_size),0,0x14 - packet_size);
      *(undefined4 *)((int)pvVar2 + 0x358) = 0;
      *(uint *)((int)pvVar2 + 0x360) = packet_size;
    }
    else {
      ...
      memcpy((void *)((int)GLOBAL_STATE.sem_1.poll_events.prev + 600),packet_data,packet_size);
      *(uint *)((int)pvVar2 + 0x358) = packet_size;
    }
    *(undefined4 *)((int)pvVar2 + 0x35c) = 1;
    k_sem_give((k_sem *)((int)pvVar2 + 0x218));
  }
  else {
    local_158[0] = '\0';
    local_158[1] = '\0';
    ...
    if (*packet_data == 0x18) {
      local_158[1] = 0xc9;
      (**(code **)((int)GLOBAL_STATE.sem_1.poll_events.prev + 0xc))(local_158,0x14);
      pGVar5 = __get_dashboard_state();
      if ((*(char *)pGVar5 == '\x02') &&
         (pGVar5 = __get_dashboard_state(), pGVar5->field_0xd5 == '\x06')) {
