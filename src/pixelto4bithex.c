/*
 * Function: pixelto4bithex
 * Entry:    00037fe4
 * Prototype: undefined __stdcall pixelto4bithex(int param_1, int param_2, undefined4 param_3, undefined4 param_4)
 */


void pixelto4bithex(int param_1,int param_2,undefined4 param_3,undefined4 param_4)
