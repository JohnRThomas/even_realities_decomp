...

{
  ...
  do {
    ...
    iVar6 = *(int *)&(pGVar2->jdb_panel_context).field_0x348;
    pGVar2 = __get_dashboard_state();
    _reflash_fb_data_to_lcd(iVar6,*(int *)&(pGVar2->jdb_panel_context).field_0x34c,0,0,0x280,199);
    iVar4 = iVar4 + -0x140;
    arch_busy_wait(5000);
  } while (iVar4 != -0xa00);
