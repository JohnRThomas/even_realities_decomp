 ...
 * Entry:    0003783e
 * Prototype: undefined4 __stdcall ui_ancs_notificaton_task(int param_1, char * param_2, int param_3, undefined4 * param_4)
 */


undefined4 ui_ancs_notificaton_task(int param_1,char *param_2,int param_3,undefined4 *param_4)

{
  ...
  if (param_3 == 2) {
    ...
    if ((((uint)DAT_200033f6 == (uint)bVar1) && (uVar8 = (uint)DAT_200033f5, DAT_200033f5 == uVar3))
       && (uVar6 = local_24[2], uVar8 = DAT_200024e0, uVar6 == DAT_200024e0)) {
      return 0;
    }
    bVar2 = pull_message(&local_24,extraout_r1_01,uVar6,uVar8);
    if (bVar2 < 10) {
      iVar7 = (uint)*(byte *)((int)local_24 + 0xf) << 0x1f;
      if (iVar7 < 0) {
