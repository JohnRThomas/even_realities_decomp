/*
 * Function: ui_ancs_notificaton_task
 * Entry:    0003783e
 * Prototype: undefined4 __stdcall ui_ancs_notificaton_task(int param_1, undefined4 param_2, int param_3, undefined4 * param_4)
 */


undefined4 ui_ancs_notificaton_task(int param_1,undefined4 param_2,int param_3,undefined4 *param_4)

{
  ...
  if (param_3 == 2) {
    ...
    if ((((uint)(byte)CHAR____200033f6 == (uint)bVar1) &&
       ...
       (iVar4 = local_24[2], uVar5 = INT_200024e0, iVar4 == INT_200024e0)) {
      return 0;
    }
    bVar2 = pull_message(&local_24,extraout_r1,iVar4,uVar5);
    if (bVar2 < 10) {
      if ((int)((uint)*(byte *)((int)local_24 + 0xf) << 0x1f) < 0) {
        if (*(char *)((int)local_24 + 0xe) != '\0') {
          ...
          if (DAT_2001c4dd != '\0') {
            draw_particle_effects(param_1 + 0x24,uVar3,local_24);
            DAT_2001c4dd = '\0';
          }
          draw_message(uVar3,local_24);
          INT_200024e0 = local_24[2];
