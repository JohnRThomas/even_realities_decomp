...

{
  ...
  if (param_1 == 0) {
    ...
    if (*(char *)((int)&pGVar1->field2781_0x1087 + 1) != '\x01') {
      return 0;
    }
    pGVar1 = __get_dashboard_state();
    *(undefined1 *)((int)&pGVar1->field2781_0x1087 + 1) = 0;
  }
  else {
    ...
    pGVar1 = __get_dashboard_state();
    if (*(char *)((int)&pGVar1->field2781_0x1087 + 1) != '\0') {
      return 0;
    }
    pGVar1 = __get_dashboard_state();
    *(undefined1 *)((int)&pGVar1->field2781_0x1087 + 1) = 1;
  }
  pGVar1 = __get_dashboard_state();
