/*
 * Function: __divdf3_outline
 * Entry:    0000dcba
 * Prototype: ulonglong __stdcall __divdf3_outline(uint param_1, uint param_2, uint param_3, uint param_4)
 */


/* exclude_from_export */

ulonglong __divdf3_outline(uint param_1,uint param_2,uint param_3,uint param_4)
...
LAB_0000daf0:
      ...
      if (param_1 != 0 || (param_2 & 0x7fffffff) != 0) goto LAB_0000db2c;
      if (param_3 != 0 || (param_4 & 0x7fffffff) != 0) goto LAB_0000daf0;
    }
  }
