/*
 * Function: flash_get_page_info
 * Entry:    000871dc
 * Prototype: int __stdcall flash_get_page_info(device * dev, off_t offs, uint32_t index, flash_pages_info * info)
 */


/* exclude_from_export */

int flash_get_page_info(device *dev,off_t offs,uint32_t index,flash_pages_info *info)
