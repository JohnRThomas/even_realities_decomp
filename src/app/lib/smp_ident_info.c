/*
 * Function: smp_ident_info
 * Entry:    0005ff60
 * Prototype: uint8_t __stdcall smp_ident_info(bt_smp * smp, net_buf * buf)
 */


/* exclude_from_export_ai */

uint8_t smp_ident_info(bt_smp *smp,net_buf *buf)

{
  ...
  if (bVar1) {
    ...
    pbVar2 = bt_keys_get_type(BT_KEYS_LTK,*(uint8_t *)(*(int *)&smp[1].dhkey_BT_DH_KEY_LEN_ + 8),
                              addr);
    ...
    puVar3 = puVar6;
    puVar5 = (undefined4 *)((int)&pbVar2->irk_val0 + 2);
    do {
      puVar4 = puVar3 + 1;
      *puVar5 = *puVar3;
      puVar3 = puVar4;
