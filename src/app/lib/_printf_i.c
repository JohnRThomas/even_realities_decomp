 ...
 * Function: _printf_i
 * Entry:    0007a3d4
 * Prototype: uint __stdcall _printf_i(int param_1, uint * param_2, undefined4 param_3, undefined * param_4, int * param_5)
 */


/* exclude_from_export */

uint _printf_i(int param_1,uint *param_2,undefined4 param_3,undefined *param_4,int *param_5)
...
LAB_0007a4bc:
    ...
    *param_2 = (uint)pcVar8;
    pcVar8 = _cvt(_Var1,param_1,param_2[1],pcVar8,(int *)&local_35,(int)&local_34,fmtch,
                  (char *)&local_30);
    if (fmtch == (int *)0x67) {
