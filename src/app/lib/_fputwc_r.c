 ...
 * Function: _fputwc_r
 * Entry:    0008a438
 * Prototype: uint __stdcall _fputwc_r(int * param_1, uint param_2, int * param_3)
 */


/* exclude_from_export */

uint _fputwc_r(int *param_1,uint param_2,int *param_3)

{
  ...
  if ((((int)((uint)*(ushort *)(param_3 + 3) << 0x1c) < 0) && (param_3[4] != 0)) ||
     (iVar3 = __swsetup_r(param_1,param_3), iVar3 == 0)) {
    uVar4 = param_2 & 0xff;
