/*
 * Function: bt_ancs_handles_assign
 * Entry:    00083094
 * Prototype: int __stdcall bt_ancs_handles_assign(bt_gatt_dm * dm, bt_ancs_client * ancs_c)
 */


/* exclude_from_export */

int bt_ancs_handles_assign(bt_gatt_dm *dm,bt_ancs_client *ancs_c)
