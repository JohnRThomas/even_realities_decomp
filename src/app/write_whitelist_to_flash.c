 ...
 * Entry:    0002478c
 * Prototype: int __stdcall write_whitelist_to_flash(int param_1, int param_2, uint param_3)
 */


int write_whitelist_to_flash(int param_1,int param_2,uint param_3)
