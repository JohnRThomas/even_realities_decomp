 ...
 * Entry:    000284f4
 * Prototype: undefined4 __stdcall spi_master_init(spi_interface_t * param_1)
 */


undefined4 spi_master_init(spi_interface_t *param_1)

{
  spi_interface_t *p_context;
  int iVar1;
  nrfx_err_t nVar2;
  SPIM4_S *pSVar3;
  uint uVar4;
  ...
  local_2c = 0xffffffff;
  uStack_28 = 0x20002;
  if (param_1->is_initialized == 1) {
    return 0;
  }
  uVar5 = (uint)*(byte *)((int)&param_1[1].init_cb + 1);
  local_48.opaque[0] = *(byte *)((int)&param_1->bus_id + 1);
  abVar7[1] = 0;
  abVar7[2] = 0;
  abVar7[3] = 0;
  abVar7[0] = local_48.opaque[0];
  local_34 = uVar5 * 1000000;
  uVar4 = (uint)*(byte *)&param_1->bus_id;
  local_44 = (uint)*(byte *)((int)&param_1->bus_id + 2);
  local_40 = (uint)*(byte *)((int)&param_1->bus_id + 3);
  local_3c = (uint)*(byte *)&param_1[1].init_cb;
  local_48.opaque[1] = 0;
  local_48.opaque[2] = 0;
  local_48.opaque[3] = 0;
  if (uVar4 == 3) {
  ...
  pSVar3 = ppSVar6[1];
  param_1->spim_device = (nrfx_spim_t)*ppSVar6;
  param_1->field4_0x10 = pSVar3;
  if (2 < iVar1) {
    if (BLE_DEBUG == 0) {
  ...
  if (*(char *)&param_1->bus_id == '\x03') {
    ...
    handler = (code *)0x0;
    p_context = (spi_interface_t *)handler;
  }
  nVar2 = nrfx_spim_init(&param_1->spim_device,&local_48,handler,p_context);
