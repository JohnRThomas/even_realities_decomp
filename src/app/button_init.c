...

{
  ...
  local_70 = &gpio0_dev;
  puStack_6c = (undefined *)0x1a;
  z_impl_gpio_pin_configure((device *)&local_70,0,param_3);
  auStack_68._0_4_ = &gpio0_dev;
  auStack_68._4_4_ = &DAT_00000019;
  z_impl_gpio_pin_configure((device *)auStack_68,0,flags);
  auStack_68._8_4_ = &gpio0_dev;
  puStack_5c = &Reserved1;
  z_impl_gpio_pin_configure((device *)(auStack_68 + 8),0,flags_00);
  local_58._0_4_ = &gpio0_dev;
  local_58._4_4_ = &DAT_0000001b;
  z_impl_gpio_pin_configure((device *)local_58,0,flags_01);
  local_58._8_4_ = &gpio0_dev;
  puStack_4c = &UsageFault;
  z_impl_gpio_pin_configure((device *)(local_58 + 8),0,flags_02);
  gpio_pin_set(&gpio0_dev,0x18,0);
  local_48._0_4_ = &gpio0_dev;
  local_48._4_4_ = &DAT_00000013;
  z_impl_gpio_pin_configure((device *)local_48,0,flags_03);
  gpio_pin_set(&gpio0_dev,0x13,0);
  local_48._8_4_ = &gpio0_dev;
  puStack_3c = &DAT_00000015;
  z_impl_gpio_pin_configure((device *)(local_48 + 8),0,flags_04);
  gpio_pin_set(&gpio0_dev,0x15,0);
  local_38 = &gpio0_dev;
  puStack_34 = &DAT_0000001e;
  z_impl_gpio_pin_configure((device *)&local_38,0,flags_05);
  gpio_pin_set(&gpio0_dev,0x1e,1);
  local_30 = &gpio0_dev;
  puStack_2c = &DAT_00000017;
  z_impl_gpio_pin_configure((device *)&local_30,0,flags_06);
