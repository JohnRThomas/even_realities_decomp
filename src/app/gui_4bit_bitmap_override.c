...

{
  ...
  if ((param_2 < 0x281) && (param_3 < 0x1e1)) {
    ...
    if (-1 < iVar1) {
      FUN_00080c4e((int)__frame_buffer,local_14,local_1c,local_18,param_2,param_3);
      iVar1 = FUN_000452e4();
      if (iVar1 << 0x1e < 0) {
        pGVar2 = __get_dashboard_state();
        uVar3 = (pGVar2->jdb_panel_context).current_row;
        pGVar2 = __get_dashboard_state();
        _reflash_fb_data_to_lcd
                  (uVar3,(pGVar2->jdb_panel_context).current_column,param_2,param_3,
