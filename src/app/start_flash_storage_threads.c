/*
 * Function: start_flash_storage_threads
 * Entry:    00025b58
 * Prototype: undefined __stdcall start_flash_storage_threads(void * param_1)
 */


void start_flash_storage_threads(void *param_1)
