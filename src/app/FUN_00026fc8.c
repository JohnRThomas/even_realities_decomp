...

{
  ...
  local_18 = param_3;
  uStack_14 = param_4;
  iVar2 = FUN_00026f90((undefined *)&local_18);
  sVar1 = (short)iVar2;
  iVar2 = (int)sVar1;
  if (iVar2 == 0) {
    if (((byte)((char)local_18 + 0x1fU) < 2) && ((local_18._1_1_ & 0xfc) == 0x40)) {
      sVar4 = (st25dv_register)local_18._2_1_;
      DAT_200083f4._2_1_ = local_18._2_1_;
      if (sVar4 == ST25DV_GPO_REG) {
        DAT_20008400 = ST25DV_RFA3SS_REG;
        sVar4 = (uStack_14._2_2_ & 0xff) << 8 | (uint)(uStack_14._2_2_ >> 8);
        sVar1 = (short)sVar4;
      }
      else {
