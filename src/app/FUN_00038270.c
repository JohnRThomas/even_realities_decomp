...

{
  ...
  if (param_3 == 2) {
    ...
    uVar5 = (uint)(ushort)pGVar1->field3671_0x108a;
    uVar3 = extraout_r1;
    if (uVar5 == DAT_200024e8) {
      pGVar2 = __get_dashboard_state();
      uVar5 = (uint)(ushort)pGVar2->field3672_0x108c;
    ...
    do {
      ...
      case 1:
        pGVar1 = __get_dashboard_state();
        DAT_200024e8 = (ushort)pGVar1->field3671_0x108a + 8;
        goto LAB_00038370;
      case 2:
        pGVar1 = __get_dashboard_state();
        DAT_200024e8 = (ushort)pGVar1->field3671_0x108a + 8;
      ...
      case 3:
        pGVar1 = __get_dashboard_state();
        DAT_200024e8 = (ushort)pGVar1->field3671_0x108a + 0x11e;
        pGVar1 = __get_dashboard_state();
        DAT_200024e4 = (ushort)pGVar1->field3672_0x108c + 8;
        goto LAB_000383c2;
      case 4:
        pGVar1 = __get_dashboard_state();
        DAT_200024e8 = (ushort)pGVar1->field3671_0x108a + 0x11e;
LAB_00038370:
        pGVar1 = __get_dashboard_state();
        DAT_200024e4 = (ushort)pGVar1->field3672_0x108c + 0x42;
LAB_000383c2:
        puVar4 = &DAT_000dbb75;
        break;
      case 5:
...
LAB_00038390:
        pGVar1 = __get_dashboard_state();
        DAT_200024e4 = (ushort)pGVar1->field3672_0x108c + 0x7b;
        goto LAB_000383c2;
      case 6:
        pGVar1 = __get_dashboard_state();
        DAT_200024e8 = (ushort)pGVar1->field3671_0x108a + 0x232;
        pGVar1 = __get_dashboard_state();
        DAT_200024e4 = (ushort)pGVar1->field3672_0x108c + 8;
        break;
      case 7:
      ...
      FUN_00080c02(param_1 + 0x24,puVar4,local_28 / 2,local_24,DAT_200024e8,DAT_200024e4);
      pGVar1 = __get_dashboard_state();
      iVar6 = *(int *)&pGVar1->field_0xeb4;
      pGVar1 = __get_dashboard_state();
      uVar5 = uVar5 + 1;
      _reflash_fb_data_to_lcd
                (iVar6,*(int *)&pGVar1->field_0xeb8,DAT_200024e8,DAT_200024e4,
