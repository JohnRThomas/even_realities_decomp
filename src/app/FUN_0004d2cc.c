 ...
 * Entry:    0004d2cc
 * Prototype: undefined __stdcall FUN_0004d2cc(dashboard_ts_context * param_1)
 */


void FUN_0004d2cc(dashboard_ts_context *param_1)

{
  ...
  local_20 = 0;
  local_1c = 0;
  __init_burial_point_date(param_1,(undefined2 *)&local_24);
