...

{
  ...
  if ((local_30 & 0xff) == 1) {
    ...
    pGVar4 = __get_dashboard_state();
    iVar3 = (*pcVar11)(pGVar4,0x403000,&DAT_20019133,0x800);
    if (iVar3 != 0) goto LAB_0002697e;
    iVar3 = uVar13 * 0x200;
    iVar14 = uVar13 * 0x143 + 4;
    m1 = (undefined4 *)(&DAT_20019134 + iVar3);
    m1_00 = (void *)(iVar3 + 0x2001915d);
    iVar12 = uVar13 * 0x143 + 0x2d;
    if ((&DAT_20019133)[iVar3] == -0x56) {
      pGVar4 = __get_dashboard_state();
      iVar3 = memcmp(m1,(void *)(*(int *)&pGVar4->field_0x1030 + iVar14),0x29);
      bVar2 = false;
      if (iVar3 != 0) {
        memset(m1,0,0x29);
        pGVar4 = __get_dashboard_state();
        puVar7 = (undefined4 *)(*(int *)&pGVar4->field_0x1030 + iVar14);
        puVar9 = puVar7;
        do {
          puVar8 = puVar9 + 1;
          puVar10 = m1 + 1;
          *m1 = *puVar9;
          puVar9 = puVar8;
          m1 = puVar10;
        } while (puVar8 != puVar7 + 10);
        bVar2 = true;
        *(undefined1 *)puVar10 = *(undefined1 *)puVar8;
      }
      pGVar4 = __get_dashboard_state();
      iVar3 = memcmp(m1_00,(void *)(*(int *)&pGVar4->field_0x1030 + iVar12),0x119);
      ...
      if (!bVar2) {
        ...
        printk("%s(): The current quicknote text is stored the same as in flash and does not need to be updated\n"
               ,"QuickNoteStoreHandler");
        return 0;
      }
    }
...
LAB_000269ec:
      ...
      pGVar4 = __get_dashboard_state();
      memcpy(m1_00,(void *)(*(int *)&pGVar4->field_0x1030 + iVar12),0x119);
    }
    FUN_00038b00();
    pGVar4 = __get_dashboard_state();
    pcVar11 = *(code **)&pGVar4->field_0x104c;
    pGVar4 = __get_dashboard_state();
    iVar3 = (*pcVar11)(pGVar4,0x403000,0x1000);
    if (iVar3 == 0) {
      pGVar4 = __get_dashboard_state();
...
LAB_00026b0a:
        if (BLE_DEBUG == 0) {
          printk(pcVar5,"QuickNoteStoreHandler",uVar1 & 0xff);
        }
        else {
          ble_printk(pcVar5);
        }
...
LAB_000268ec:
      ...
      printk(pcVar5,"QuickNoteStoreHandler");
      return -1;
    }
    if (2 < LOG_LEVEL) {
      if (BLE_DEBUG == 0) {
...
LAB_0002698e:
      if (BLE_DEBUG == 0) {
        printk(pcVar5,"QuickNoteStoreHandler",pcVar6);
      }
      else {
        ble_printk(pcVar5);
      }
...
LAB_0002697e:
      ...
      pcVar6 = (char *)0x403000;
      pcVar5 = "%s():  form address [%d] read data failed.\n\n";
      goto LAB_0002698e;
    }
    memset(&DAT_20019133 + uVar13 * 0x200,0xff,0x200);
    pGVar4 = __get_dashboard_state();
    pcVar11 = *(code **)&pGVar4->field_0x104c;
    pGVar4 = __get_dashboard_state();
    iVar3 = (*pcVar11)(pGVar4,0x403000,0x1000);
...
LAB_00026a40:
  if (BLE_DEBUG == 0) {
    printk(pcVar5,"QuickNoteStoreHandler",iVar3);
    return iVar3;
  }
  ble_printk(pcVar5);
  return iVar3;
