...

{
  ...
  param_1->field2832_0x10b8 = local_ac;
  *(int *)&param_1->field_0x1064 = local_b0;
  param_1->field_0x2 = local_a8;
  *(undefined4 *)&param_1->field_0xf68 = local_a4;
  *(undefined4 *)&(param_1->opt3007_context).field_0x14 = local_a0;
  ...
  param_1->field2831_0x10b4 = local_54;
  param_1->field2794_0x108a = local_50;
  param_1->field2795_0x108c = local_4e;
  ...
  *(undefined2 *)&(param_1->jdb_panel_context).field_0x372 = local_38;
  param_1->field2833_0x10bc = local_2c;
  param_1->field2834_0x10c0 = uStack_28;
  param_1->field2835_0x10c4 = local_24;
  param_1->field2830_0x10b0 = local_20;
  ...
  if (local_b0 != 1) {
    ...
    param_1->field2832_0x10b8 = 0;
    *(undefined4 *)&(param_1->opt3007_context).field_0x14 = 80000;
    *(undefined4 *)&param_1->field_0xf68 = 0;
    (param_1->jdb_panel_context).field_0x368 = 0;
    param_1->field2794_0x108a = 0x20;
    param_1->field2795_0x108c = 0x20;
    *(undefined2 *)&param_1->field_0x10a8 = 0;
    param_1->field2831_0x10b4 = 0;
    ...
    *(undefined4 *)&param_1->field_0xfb8 = 0;
    param_1->field2833_0x10bc = 0;
    param_1->field2834_0x10c0 = 0;
    param_1->field2835_0x10c4 = 0;
    param_1->field2830_0x10b0 = 0;
  ...
  *(undefined4 *)&param_1->field_0x1064 = 1;
  ...
  if (0x14 < (ushort)(param_1->field2794_0x108a - 0x16)) {
    param_1->field2794_0x108a = 0x20;
  }
  if ((ushort)param_1->field2795_0x108c < 0x41) {
    if (3 < (ushort)param_1->field2795_0x108c) goto LAB_00024dfc;
    uVar3 = 4;
  }
  else {
    uVar3 = 0x20;
  }
  param_1->field2795_0x108c = uVar3;
LAB_00024dfc:
