...

{
  ...
  param_1->field2821_0x10b8 = local_ac;
  ...
  *(undefined4 *)&(param_1->opt3007_context).field_0x14 = local_a0;
  ...
  param_1->field2820_0x10b4 = local_54;
  param_1->field2783_0x108a = local_50;
  param_1->field2784_0x108c = local_4e;
  ...
  *(undefined2 *)&(param_1->jdb_panel_context).field_0x372 = local_38;
  param_1->field2822_0x10bc = local_2c;
  param_1->field2823_0x10c0 = uStack_28;
  param_1->field2824_0x10c4 = local_24;
  param_1->field2819_0x10b0 = local_20;
  ...
  if (local_b0 != 1) {
    ...
    *(undefined4 *)&(param_1->imu_fusion_context).field_0x80 = 0;
    ...
    param_1->field2783_0x108a = 0x20;
    param_1->field2784_0x108c = 0x20;
    *(undefined2 *)&param_1->field_0x10a8 = 0;
    param_1->field2820_0x10b4 = 0;
    ...
    *(undefined4 *)&param_1->field_0xfb8 = 0;
    param_1->field2822_0x10bc = 0;
    param_1->field2823_0x10c0 = 0;
    param_1->field2824_0x10c4 = 0;
    param_1->field2819_0x10b0 = 0;
  ...
  *(undefined4 *)&param_1->field_0x1064 = 1;
  ...
  if (0x14 < (ushort)(param_1->field2783_0x108a - 0x16)) {
    param_1->field2783_0x108a = 0x20;
  }
  if ((ushort)param_1->field2784_0x108c < 0x41) {
    if (3 < (ushort)param_1->field2784_0x108c) goto LAB_00024dfc;
    uVar4 = 4;
  }
  else {
    uVar4 = 0x20;
  }
  param_1->field2784_0x108c = uVar4;
LAB_00024dfc:
