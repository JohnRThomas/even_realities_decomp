/*
 * Function: ?_ui_DashBoard_task
 * Entry:    0003cdb4
 * Prototype: undefined4 __stdcall ?_ui_DashBoard_task(int param_1, undefined4 param_2, int param_3)
 */
...
undefined4 __ui_DashBoard_task(int param_1,undefined4 param_2,int param_3)
  ...
  if (DAT_20004af8 == '\0') {
    ...
    if (cRam20004b04 == '\0') {
        ...
        do {
          ...
          do {
            ...
            if (bVar2 != 0) {
              *(byte *)(iVar17 + iVar9) =
                   bVar2 & (&DAT_000accab)
                           [iVar9 + (uint)*(byte *)((int)&local_30 + DAT_2000a9b0) * 0x140 +
                                    (uVar8 % 0x1a) * 0xa00];
            }
            iVar9 = iVar9 + 1;
          } while (iVar9 != 0x140);
      ...
      if (*(char *)pGVar6 == '\x01') {
        ...
        if (PANE_MODE == 0) {
          bVar2 = FUN_00038ac8();
          uVar8 = (bVar2 & 0xf) << 4 | local_30 >> 8 & 0xff;
          local_30._0_2_ = CONCAT11((char)uVar8,(undefined1)local_30);
          if (2 < LOG_LEVEL) {
...
LAB_0003d002:
          ...
          if (PANE_MODE == 2) {
            ...
            local_30 = CONCAT22(local_30._2_2_,0x802);
...
LAB_0003d00c:
        pGVar6 = __get_dashboard_state();
        uVar8 = sync_to_slave((char *)pGVar6,6,&local_30,2);
        if ((int)uVar8 < 5000) {
          if (2 < LOG_LEVEL) {
            if (BLE_DEBUG == 0) {
              uVar10 = FUN_00080732();
...
LAB_0003d09a:
    ...
    uVar10 = send_response_data_to_msgqueue(&local_30,6);
  ...
  if (LOG_LEVEL < 3) {
    ...
    if (param_3 != 2) goto LAB_0003d6c6;
  }
  else {
    if (BLE_DEBUG == 0) {
...
LAB_0003d6c6:
      ...
      if (param_3 != 4) {
        if (param_3 == 6) {
          ...
          if (param_3 != 7) goto LAB_0003d43e;
          if (2 < LOG_LEVEL) {
            if (BLE_DEBUG == 0) {
