...

{
  ...
  if ((((param_3 == (undefined4 *)0x0) || (param_4 == (undefined1 *)0x0)) || (param_1 == 0)) ||
    ...
    *puVar4 = 0x3d;
    ...
    pGVar3 = __get_dashboard_state();
    *(undefined4 *)(puVar4 + 6) = pGVar3->field1250_0x10b0;
    pGVar3 = __get_dashboard_state();
    *(undefined4 *)(puVar4 + 10) = pGVar3->field1251_0x10b4;
    pGVar3 = __get_dashboard_state();
    *(undefined4 *)(puVar4 + 0xe) = pGVar3->field1252_0x10b8;
    puVar6 = (undefined2 *)(puVar4 + 0x12);
    do {
      pGVar3 = __get_dashboard_state();
      iVar1 = iVar5 * 2;
      iVar5 = iVar5 + 1;
      *puVar6 = *(undefined2 *)(pGVar3->field1211_0x1080 + iVar1 + 0x3c);
      puVar6 = puVar6 + 1;
    } while (iVar5 != 6);
    pGVar3 = __get_dashboard_state();
