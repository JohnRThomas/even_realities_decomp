...

{
  ...
  if (param_1 == (char *)0x0) {
    ...
    if (object != (cJSON *)0x0) {
      __cJSON_AddBoolToObject(object,"call_enable",DAT_2001aefb & 1);
      __cJSON_AddBoolToObject(object,"msg_enable",(DAT_2001aefb & 3) >> 1);
      __cJSON_AddBoolToObject(object,"ios_mail_enable",(DAT_2001aefb & 7) >> 2);
      __cJSON_AddBoolToObject(object,"calendar_enable",(DAT_2001aefb & 0xf) >> 3);
      ...
      if (object_00 == (cJSON *)0x0) {
        ...
        __cJSON_AddBoolToObject(object_00,"enable",(DAT_2001aefb & 0x1f) >> 4);
        array = __cJSON_CreateArray();
        if (array == (cJSON *)0x0) {
          uVar3 = 0x20e;
          ...
          while( true ) {
            ...
            if (DAT_2001aefc <= uVar4) {
              __cJSON_AddItemToObject(object_00,"list",array);
              __cJSON_AddItemToObject(object,s_M_s_fuentes_en_la_app_000be53f + 0x13,object_00);
            ...
            object_01 = __cJSON_CreateObject();
            uVar6 = uVar6 + 1;
            if (object_01 == (cJSON *)0x0) break;
            iVar5 = uVar4 * 0x38;
            __cJSON_AddStringToObject(object_01,"id",&DAT_2001aefd + iVar5);
            __cJSON_AddStringToObject(object_01,"name",&DAT_2001af25 + iVar5);
