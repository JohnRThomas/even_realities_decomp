...

{
  ...
  uVar11 = FUN_0007fea6();
  if ((int)((ulonglong)uVar11 >> 0x20) < (int)(uint)((uint)uVar11 < 10000)) {
    return;
  }
  pGVar2 = __get_dashboard_state();
      ...
      if (bVar1 <= DAT_20019a55) {
        ...
        if (param_1 == 0) {
          if (uVar10 != 4) {
            ...
            change_work_mode(4);
            if (0 < (int)LOG_LEVEL) {
              pcVar4 = "%s(): MODE_NORMAL_LOW_POWER_ID\n";
              uVar3 = extraout_r2_09;
              goto LAB_00029a46;
            }
          }
        }
          ...
          change_work_mode(5);
          if (0 < (int)LOG_LEVEL) {
            pcVar4 = "%s(): MODE_CHARGING_RUN_ID\n";
            uVar3 = extraout_r2_08;
            goto LAB_00029a46;
          }
        }
        else {
          ...
          change_work_mode(6);
          if (0 < (int)LOG_LEVEL) {
            pcVar4 = "%s(): MODE_CHARGING_LOW_POWER_ID\n";
...
LAB_00029a46:
            if (BLE_DEBUG == 0) {
              ...
              ble_printk(pcVar4,"check_work_mode",uVar3,BLE_DEBUG);
            }
          }
        }
      }
...
LAB_000299ec:
    ...
    if (uVar10 - 2 < 2) {
      ...
      is_box_charging = FUN_0002da10((int)pGVar2);
      uVar3 = 0;
      if ((is_box_charging) && (uVar3 = change_work_mode(2), 0 < (int)LOG_LEVEL)) {
        pcVar4 = "%s(): MODE_NORMAL_RUN_ID\n";
      ...
      uVar3 = change_work_mode(3);
      if (0 < (int)LOG_LEVEL) {
        pcVar4 = "%s(): MODE_NORMAL_STANBY_ID\n";
...
LAB_00029938:
      *pbVar8 = bVar1;
      ...
      DAT_20019a60 = '\x02';
      pbVar8 = (byte *)&DAT_20019a54;
      bVar1 = DAT_20019a54 + 1;
      if (bVar1 < 10) goto LAB_00029938;
      DAT_20019a54 = '\0';
      iVar5 = FUN_00031990(uVar3,0,&DAT_20019a54);
      if (iVar5 != 0) {
        FUN_00032130(iVar5,extraout_r1_04);
      }
    }
    if (param_1 != 0) {
  ...
  if ((DAT_2000304d == -1) ||
    ...
    if ((pGVar2->__work_mode_sem).count == 2) {
      ...
      timeout_00.ticks._0_4_ = extraout_r1_06;
...
LAB_00029828:
    ...
    if (is_box_charging) {
      ...
      if (0 < (int)LOG_LEVEL) {
        if (BLE_DEBUG == 0) {
          ...
          uVar3 = extraout_r1_16;
        }
        else {
          ble_printk("%s(): EVENT_UNWARED_OUTBOX\n","check_work_mode",extraout_r2_10,BLE_DEBUG);
          uVar3 = extraout_r1_15;
        }
      }
      uVar10 = 7;
    }
  ...
  if (DAT_20003050 != uVar10) {
    FUN_00029774(uVar10,uVar3,puVar6);
    DAT_20003050 = (char)uVar10;
    return;
  }
  pGVar2 = __get_dashboard_state();
  bVar1 = pGVar2->field_0xfc4;
  puVar9 = (undefined1 *)(uint)bVar1;
  puVar6 = (undefined1 *)(uint)DAT_2000304a;
  if ((puVar6 != puVar9) && (puVar9 < (undefined1 *)0x65)) {
    DAT_2000304a = bVar1;
    if (0 < (int)LOG_LEVEL) {
      if (BLE_DEBUG == 0) {
        printk("%s(): EVENT_STATE_BATTERY_PERCENT %d\n");
        puVar6 = extraout_r1_18;
        puVar9 = extraout_r2_16;
      }
      else {
        ble_printk("%s(): EVENT_STATE_BATTERY_PERCENT %d\n","check_work_mode",puVar9,BLE_DEBUG);
        puVar6 = extraout_r1_17;
        puVar9 = extraout_r2_15;
      }
    }
    iVar5 = 10;
    goto LAB_00029bb2;
...
LAB_00029c2c:
      ...
      DAT_20019a52 = 0;
      pGVar2 = __get_dashboard_state();
      DAT_20003049 = (byte)uVar10;
      pGVar2->field_0x794 = DAT_20003049;
      FUN_00029774(9,extraout_r1_23,extraout_r2_20);
      if ((int)LOG_LEVEL < 1) {
        return;
      }
      if (BLE_DEBUG == 0) {
    ...
    uVar10 = (uint)is_box_charging;
    if (uVar10 == 0) {
      if (DAT_20003049 != 0) goto LAB_00029c2a;
    }
    else {
      DAT_20019a52 = '\x04';
      if (DAT_20003049 != uVar10) goto LAB_00029c2c;
    }
    DAT_20019a52 = '\0';
    bVar1 = FUN_00033754();
    uVar10 = (uint)bVar1;
    puVar6 = &DAT_20019a53;
    if (DAT_2000304b != uVar10) {
      DAT_20019a53 = DAT_20019a53 + 1;
      if (4 < DAT_20019a53) {
        DAT_20019a53 = 0;
        uVar3 = extraout_r1_19;
        DAT_2000304b = bVar1;
        if (0 < (int)LOG_LEVEL) {
          if (BLE_DEBUG == 0) {
            printk("%s(): EVENT_GLASS_BOX_STATUS %d\n");
            uVar3 = extraout_r1_25;
            puVar6 = extraout_r2_22;
          }
          else {
            ble_printk("%s(): EVENT_GLASS_BOX_STATUS %d\n","check_work_mode",uVar10,BLE_DEBUG);
            uVar3 = extraout_r1_24;
            puVar6 = extraout_r2_21;
          }
        }
        FUN_00029774(0xe,uVar3,puVar6);
      }
      if ((int)LOG_LEVEL < 1) {
        return;
      }
    ...
    uVar10 = (uint)bVar1;
    puVar6 = &DAT_2000304c;
    if ((DAT_2000304c != uVar10) && (uVar10 < 0x65)) {
      puVar9 = LOG_LEVEL;
      DAT_2000304c = bVar1;
      if (0 < (int)LOG_LEVEL) {
        if (BLE_DEBUG == 0) {
          printk("%s(): EVENT_GLASS_BOX_SOC %d\n","check_work_mode",uVar10);
          puVar6 = extraout_r1_26;
          puVar9 = extraout_r2_23;
        }
        else {
          ble_printk("%s(): EVENT_GLASS_BOX_SOC %d\n","check_work_mode",uVar10,uVar10);
          puVar6 = extraout_r1_20;
          puVar9 = extraout_r2_17;
        }
      }
      iVar5 = 0xf;
      goto LAB_00029bb2;
  ...
  pGVar2 = __get_dashboard_state();
  bVar1 = FUN_00010848(&pGVar2->opt3007_context,extraout_r1_21,extraout_r2_18);
  if (bVar1 == 0xff) {
    return;
  }
  pGVar2 = __get_dashboard_state();
  if (pGVar2->field_0xed5 == DAT_20003048) {
    return;
  }
  pGVar2 = __get_dashboard_state();
  DAT_20003048 = pGVar2->field_0xed5;
  iVar5 = 0x12;
  puVar6 = extraout_r1_22;
  puVar9 = extraout_r2_19;
LAB_00029bb2:
  FUN_00029774(iVar5,puVar6,puVar9);
  return;
}
