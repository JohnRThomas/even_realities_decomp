 ...
 * Entry:    00035070
 * Prototype: undefined4 __stdcall get_notification_counts_cmd_response(int param_1, byte * param_2, undefined4 param_3, undefined4 param_4)
 */
...

{
  ...
  if ((param_1 == 0) || (param_2 == (byte *)0x0)) {
    if (1 < LOG_LEVEL) {
      if (BLE_DEBUG == 0) {
        printk("%s(): input param is error !\n","get_notification_counts_cmd_response",param_3,0,
               param_4);
      }
      else {
