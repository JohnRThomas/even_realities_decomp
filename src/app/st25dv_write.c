 ...
 * Entry:    0002787c
 * Prototype: uint __stdcall ?_st25dv_write(undefined4 * param_1, undefined4 param_2, st25dv_register param_3, void * param_4, size_t param_5)
 */


uint __st25dv_write(undefined4 *param_1,undefined4 param_2,st25dv_register param_3,void *param_4,
                   size_t param_5)

{
  ...
  auStack_28[iVar1] = (char)(param_3 >> 8);
