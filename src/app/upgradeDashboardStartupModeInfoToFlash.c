 ...
 * Entry:    00025d00
 * Prototype: undefined4 __stdcall upgradeDashboardStartupModeInfoToFlash(undefined4 param_1, undefined4 param_2, undefined4 param_3)
 */
...

{
  ...
  uStack_10 = param_3;
  iVar1 = z_impl_k_msgq_put((k_msgq *)&DAT_20003b34,&local_18,(k_timeout_t)0x0);
  if (iVar1 == 0) {
    if (2 < LOG_LEVEL) {
      if (BLE_DEBUG == 0) {
