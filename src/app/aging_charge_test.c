...

{
  ...
  if (DAT_2001abc0 == '\x01') {
    ...
    pGVar5->field1250_0x10b0 = (int)uVar11 - iVar9;
    pGVar5 = __get_dashboard_state();
    if ((uint)pGVar5->field1250_0x10b0 < 0x385) {
      pGVar5 = __get_dashboard_state();
      uVar6 = 0x3c;
      uVar7 = pGVar5->field1250_0x10b0;
    }
    else {
      pGVar5 = __get_dashboard_state();
      uVar6 = 900;
    ...
    if (DAT_2001abc1 == '\x01') {
      ...
      if (0x60 < (byte)pGVar5->field_0xfc4) {
        ...
        pGVar5 = __get_dashboard_state();
        uVar11 = __aeabi_ldivmod((uint)uVar11,(uint)((ulonglong)uVar11 >> 0x20),1000,0);
        pGVar5->field1251_0x10b4 = (int)uVar11 - iVar9;
        goto LAB_000340fe;
      }
    }
      ...
      if ((byte)pGVar5->field_0xfc4 < 0x47) {
        ...
        do {
          ...
          iVar4 = iVar8 * 2;
          iVar8 = iVar8 + 1;
          iVar9 = iVar9 - (uint)*(ushort *)(pGVar5->field1211_0x1080 + iVar4 + 0x3c);
        } while (iVar8 != 5);
        pGVar5 = __get_dashboard_state();
        *(short *)((int)&pGVar5->field1255_0x10c4 + 2) = (short)iVar9;
        uVar11 = FUN_00080638();
        ...
        if ((int)((DAT_2000493c - iVar9) - (uint)bVar10) < 0 ==
          ...
          uVar11 = __aeabi_ldivmod((uint)lVar12,(uint)((ulonglong)lVar12 >> 0x20),1000,0);
          pGVar5 = __get_dashboard_state();
          pGVar5->field1252_0x10b8 = (int)uVar11;
        }
        DAT_2001abc1 = '\0';
        goto LAB_000340fe;
      }
      ...
      if (((byte)pGVar5->field_0xfc4 < 0x4c) &&
         (pGVar5 = __get_dashboard_state(), *(short *)&pGVar5->field1255_0x10c4 == 0)) {
        lVar12 = FUN_00080638();
        lVar12 = lVar12 - CONCAT44(DAT_2000493c,DAT_20004938);
        uVar11 = __aeabi_ldivmod((uint)lVar12,(uint)((ulonglong)lVar12 >> 0x20),1000,0);
        iVar8 = (int)uVar11;
        ...
        do {
          ...
          iVar4 = iVar9 * 2;
          iVar9 = iVar9 + 1;
          iVar8 = iVar8 - (uint)*(ushort *)(pGVar5->field1211_0x1080 + iVar4 + 0x3c);
        } while (iVar9 != 4);
        pGVar5 = __get_dashboard_state();
        *(short *)&pGVar5->field1255_0x10c4 = (short)iVar8;
        goto LAB_000340fe;
      }
      pGVar5 = __get_dashboard_state();
      if (((byte)pGVar5->field_0xfc4 < 0x51) &&
         (pGVar5 = __get_dashboard_state(), *(short *)((int)&pGVar5->field1254_0x10c0 + 2) == 0)) {
        lVar12 = FUN_00080638();
        lVar12 = lVar12 - CONCAT44(DAT_2000493c,DAT_20004938);
        uVar11 = __aeabi_ldivmod((uint)lVar12,(uint)((ulonglong)lVar12 >> 0x20),1000,0);
        pGVar5 = __get_dashboard_state();
        sVar1 = *(short *)&pGVar5->field1253_0x10bc;
        pGVar5 = __get_dashboard_state();
        sVar2 = *(short *)((int)&pGVar5->field1253_0x10bc + 2);
        pGVar5 = __get_dashboard_state();
        sVar3 = *(short *)&pGVar5->field1254_0x10c0;
        pGVar5 = __get_dashboard_state();
        *(short *)((int)&pGVar5->field1254_0x10c0 + 2) = (((short)uVar11 - sVar1) - sVar2) - sVar3;
        goto LAB_000340fe;
      }
      pGVar5 = __get_dashboard_state();
      if (((byte)pGVar5->field_0xfc4 < 0x56) &&
         (pGVar5 = __get_dashboard_state(), *(short *)&pGVar5->field1254_0x10c0 == 0)) {
        lVar12 = FUN_00080638();
        lVar12 = lVar12 - CONCAT44(DAT_2000493c,DAT_20004938);
        uVar11 = __aeabi_ldivmod((uint)lVar12,(uint)((ulonglong)lVar12 >> 0x20),1000,0);
        pGVar5 = __get_dashboard_state();
        ...
        sVar2 = *(short *)((int)&pGVar5->field1253_0x10bc + 2);
        pGVar5 = __get_dashboard_state();
        *(short *)&pGVar5->field1254_0x10c0 = ((short)uVar11 - sVar1) - sVar2;
        goto LAB_000340fe;
      }
      pGVar5 = __get_dashboard_state();
      if (((byte)pGVar5->field_0xfc4 < 0x5b) &&
         (pGVar5 = __get_dashboard_state(), *(short *)((int)&pGVar5->field1253_0x10bc + 2) == 0)) {
        lVar12 = FUN_00080638();
        lVar12 = lVar12 - CONCAT44(DAT_2000493c,DAT_20004938);
        uVar11 = __aeabi_ldivmod((uint)lVar12,(uint)((ulonglong)lVar12 >> 0x20),1000,0);
        pGVar5 = __get_dashboard_state();
        sVar1 = *(short *)&pGVar5->field1253_0x10bc;
        pGVar5 = __get_dashboard_state();
        *(short *)((int)&pGVar5->field1253_0x10bc + 2) = (short)uVar11 - sVar1;
        goto LAB_000340fe;
      }
      pGVar5 = __get_dashboard_state();
      if (((byte)pGVar5->field_0xfc4 < 0x60) &&
         (pGVar5 = __get_dashboard_state(), *(short *)&pGVar5->field1253_0x10bc == 0)) {
        lVar12 = FUN_00080638();
        lVar12 = lVar12 - CONCAT44(DAT_2000493c,DAT_20004938);
        uVar11 = __aeabi_ldivmod((uint)lVar12,(uint)((ulonglong)lVar12 >> 0x20),1000,0);
        pGVar5 = __get_dashboard_state();
        *(short *)&pGVar5->field1253_0x10bc = (short)uVar11;
        goto LAB_000340fe;
      }
    }
    else {
