        ...
        if (iVar5 == 0) {
          ...
          if (iVar5 < 0) {
            ...
            if ((uint)(param_6 - param_4) < local_2f4) {
              ...
              FUN_00080c02(DAT_2000aa14,local_2cc,sVar1,uVar3,local_2e8,uVar10 + param_5);
              iVar5 = FUN_000462b0((uint)*puVar4,(uint)*puVar12);
              local_2f8 = iVar5 + local_2d4;
              local_2f4 = local_2f8;
            }
            else {
              FUN_00080c02(DAT_2000aa14,local_2cc,sVar1,uVar3,local_2e8 + local_2f8,uVar10 + param_5
                          );
              iVar5 = FUN_000462b0((uint)*puVar4,(uint)*puVar12);
