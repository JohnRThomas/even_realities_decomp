...

{
  ...
  if (0 < param_4) {
    ...
    while( true ) {
      ...
      uVar9 = uVar9 + 5;
      iVar5 = (int)(short)*(undefined4 *)(iVar5 + 0x28) * (int)(short)(&PTR_0008f9f0)[uVar6 * 0xc] +
              (int)(short)((uint)*(undefined4 *)(iVar5 + 0x28) >> 0x10) *
              (int)(short)((uint)(&PTR_0008f9f0)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 0x24) *
              (int)(short)(&PTR_DAT_0008f9ec)[uVar6 * 0xc] +
              (int)(short)((uint)*(undefined4 *)(iVar5 + 0x24) >> 0x10) *
              (int)(short)((uint)(&PTR_DAT_0008f9ec)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 0x20) *
              (int)(short)(&PTR_DAT_0008f9e8)[uVar6 * 0xc] +
              (int)(short)((uint)*(undefined4 *)(iVar5 + 0x20) >> 0x10) *
              (int)(short)((uint)(&PTR_DAT_0008f9e8)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 0x1c) *
              (int)(short)(&PTR_LAB_0008f9e4)[uVar6 * 0xc] +
              (int)(short)((uint)*(undefined4 *)(iVar5 + 0x1c) >> 0x10) *
              (int)(short)((uint)(&PTR_LAB_0008f9e4)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 0x18) *
              (int)(short)(&PTR_DAT_0008f9e0)[uVar6 * 0xc] +
              (int)(short)((uint)*(undefined4 *)(iVar5 + 0x18) >> 0x10) *
              (int)(short)((uint)(&PTR_DAT_0008f9e0)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 0x14) *
              (int)(short)(&PTR_DAT_0008f9dc)[uVar6 * 0xc] +
              (int)(short)((uint)*(undefined4 *)(iVar5 + 0x14) >> 0x10) *
              (int)(short)((uint)(&PTR_DAT_0008f9dc)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 0x10) *
              (int)(short)(&PTR_DAT_0008f9d8)[uVar6 * 0xc] +
              (int)(short)((uint)*(undefined4 *)(iVar5 + 0x10) >> 0x10) *
              (int)(short)((uint)(&PTR_DAT_0008f9d8)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 0xc) *
              (int)(short)(&PTR_DAT_0008f9d4)[uVar6 * 0xc] +
              (int)(short)((uint)*(undefined4 *)(iVar5 + 0xc) >> 0x10) *
              (int)(short)((uint)(&PTR_DAT_0008f9d4)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 8) * (int)(short)(&PTR_DAT_0008f9d0)[uVar6 * 0xc]
              + (int)(short)((uint)*(undefined4 *)(iVar5 + 8) >> 0x10) *
                (int)(short)((uint)(&PTR_DAT_0008f9d0)[uVar6 * 0xc] >> 0x10) +
              (int)(short)*(undefined4 *)(iVar5 + 4) * (int)(short)(&PTR_DAT_0008f9cc)[uVar6 * 0xc]
              + (int)(short)((uint)*(undefined4 *)(iVar5 + 4) >> 0x10) *
                (int)(short)((uint)(&PTR_DAT_0008f9cc)[uVar6 * 0xc] >> 0x10) +
      ...
      *param_3 = (short)(uVar6 + 0x8000 >> 0x10);
      ...
      puVar8 = (&PTR_DAT_0008f9c8)[(uVar9 & 7) * 0xc];
      uVar6 = uVar9 & 7;
      param_3 = param_3 + 1;
    }
  }
