/*
 * Function: start_display_thread_handler
 * Entry:    0004c7ac
 * Prototype: undefined4 __stdcall start_display_thread_handler(void * param_1)
 */


undefined4 start_display_thread_handler(void *param_1)
