...

{
  ...
  if (cVar1 == '\0') {
    pGVar2 = __get_dashboard_state();
    iVar3 = memcmp(pGVar2->field3664_0x1080 + 1,addr,7);
    if (iVar3 != 0) {
      pGVar2 = __get_dashboard_state();
      bt_unpair('\0',(bt_addr_le_t *)(pGVar2->field3664_0x1080 + 1));
      pGVar2 = __get_dashboard_state();
      *(undefined1 *)((int)&pGVar2->field3665_0x1087 + 1) = 0;
      pGVar2 = __get_dashboard_state();
  ...
  pGVar2 = __get_dashboard_state();
  *(sys_snode_t **)(pGVar2->field3664_0x1080 + 1) = (addr->work).node.next;
  *(undefined2 *)(pGVar2->field3664_0x1080 + 5) = *(undefined2 *)&(addr->work).handler;
  *(undefined1 *)&pGVar2->field3665_0x1087 = *(undefined1 *)((int)&(addr->work).handler + 2);
